...
let picsFromNewbornStarsAlbum = document.getElementById("pics-from-newborn-stars-album-div");
let headerImageNewbornStarsAlbum = document.getElementById("newborn-stars-header-image");
...
window.onload = function () {
    console.log("picsFromPlanetsAlbum: " + picsFromNewbornStarsAlbum);
        ...
        .then(function (data) {
            ...
            function playSlideShow() {
                ...
                if (imgPicked[0] == false && imgPicked[1] == false && imgPicked[2] == false) {
                    ...
                    for (let i = 0; i < data.albums[2].pictures.length; i++) {
                        if (imgPicked[i] == true) {
                            images[j] = data.albums[2].path + `/` + data.albums[2].pictures[i].imgLoRes; // All highlighted images are stored in the 'images' array
