...
window.onload = function () {
    console.log("picsFromPlanetsAlbum: " + picsFromNebulosAlbum);
    ...
    fetch("../app-data/library/picture-library.json")
        ...
        .then(function (data) {
            console.log(data);
            console.log(data.albums[1].pictures.length);
            ...
            headerImageNebulosAlbum.innerHTML += (`<img src="../app-data/library/pictures/album-header/GSFC_20171208_Archive_e000383~small.jpg">`);
            ...
            function playSlideShow() {
                ...
                if (imgPicked[0] == false && imgPicked[1] == false && imgPicked[2] == false && imgPicked[3] == false && imgPicked[4] == false && imgPicked[5] == false) {
                    ...
                    for (let i = 0; i < data.albums[1].pictures.length; i++) {
                        if (imgPicked[i] == true) {
                            images[j] = data.albums[1].path + `/` + data.albums[1].pictures[i].imgHiRes; // All highlighted images are stored in the 'images' array
